...
function mgf( t, options ) {
	...
	if ( isMatrixLike( t ) ) {
		...
		return mgf5( out, t, opts.mu, opts.s );
	}
	if ( isTypedArrayLike( t ) ) {
		...
		return mgf6( out, t, opts.mu, opts.s );
	}
	if ( isArrayLike( t ) ) {
		// Handle deepset first...
		if ( opts.path ) {
			opts.sep = opts.sep || '.';
			return mgf4( t, opts.mu, opts.s, opts.path, opts.sep );
		}
		...
		if ( opts.accessor ) {
			return mgf3( out, t, opts.mu, opts.s, opts.accessor );
		}
		return mgf2( out, t, opts.mu, opts.s );
	}
	return NaN;
} // end FUNCTION mgf()
